      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <form
            ...
            className="bg-white/70 backdrop-blur p-8 rounded-2xl shadow-xl w-96 flex flex-col gap-6 border border-blue-100"
          >
            <h2 className="text-3xl font-bold mb-2 text-center text-gray-900">Admin Login</h2>
            <p className="text-center text-gray-500 mb-2">Enter your admin credentials to access the dashboard.</p>
            <input
              type="text"
